...
const gameData = {
	...
	manApproached: {
		...
		You see that he is holding a medpack, the only thing keeping him alive.<br/><br/>
        Do you take it from him and leave or leave him be? (+1 medpack)`,
		options: [
			{
	...
	room2: {
		img: "roomBookshelves.jpg",
		text: `You managed to catch a medpack during the frenzy (+1 Medpack).<br/><br/>
	...
	elevator: {
		...
		options: [
			{ text: "Ascend to the final floor", next: "" }, //next floor logic just need to link it to the next html page
